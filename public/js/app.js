...
// 1. Registro de componentes de Alpine
Alpine.data('app', () => ({
  ...
  async cargarComprobantes() {
    try {
      ...
      console.error('[Glaukov UI ❌] Error cargando comprobantes:', err);
    }
  },
  ...
  async cargarSocios() {
    try {
      ...
      console.error('[Glaukov UI ❌] Error cargando socios:', err);
    }
  },
...
// 2. Inicialización limpia y única de Alpine
